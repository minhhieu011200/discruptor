...
public class MetricAspect {
        ...
        public Object aroundMeasured(ProceedingJoinPoint pjp, Measured measured)
                ...
                // Lấy hoặc tạo Timer
                Timer timer = timers.computeIfAbsent(metricName, k -> Timer.builder("queue_handler_duration")
                ...
                Counter counter = counters.computeIfAbsent(metricName, k -> Counter.builder("queue_received_total")
                                .tag("queue_name", metricName)
                                .description(measured.description())
                                .register(meterRegistry));
